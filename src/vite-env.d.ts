...
interface ImportMetaEnv {
  ...
  readonly VITE_SUPABASE_TEMPLATE_SUBTITLE_COLUMN?: string;
  readonly VITE_SUPABASE_TEMPLATE_DESCRIPTION_COLUMN?: string;
  ...
  readonly VITE_SUPABASE_TEMPLATE_CARD_IMAGE_1_COLUMN?: string;
  readonly VITE_SUPABASE_TEMPLATE_CARD_IMAGE_2_COLUMN?: string;
  readonly VITE_SUPABASE_TEMPLATE_CARD_IMAGE_3_COLUMN?: string;
  readonly VITE_SUPABASE_TEMPLATE_CARD_IMAGE_4_COLUMN?: string;
